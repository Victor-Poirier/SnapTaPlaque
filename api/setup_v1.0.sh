#!/bin/bash
# setup.sh : Setup complet sans sudo pour PostgreSQL
...
# ⚠️ Assurez-vous que l'utilisateur courant a déjà un rôle PostgreSQL avec droits suffisants
PGUSER="${PGUSER:-$USER}"   # l'utilisateur courant
PGHOST="${PGHOST:-localhost}"

echo "🚀 Création de la base et de l'utilisateur (sans sudo)..."
